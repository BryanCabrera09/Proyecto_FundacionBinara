...
export class TranslatorService {
  ...
  private headers = new HttpHeaders().set('Content-Type', 'application/json')
    .set('Ocp-Apim-Subscription-Key', '')   /* Nueva Key: 1fb564ddad3245dbae5a9ff4a840fc41   o  ca19a4d477f14449a78b013d3a63aa27 */
    .set('Ocp-Apim-Subscription-Region', '');   /* Region: eastus2    o    eastus */
